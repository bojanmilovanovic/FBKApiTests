...
public class TestC127321939UpdateFormRouteStatusNegativeScenarioAError {

    private String statusBefore = "A_error";
    private String[] statusAfter = new String[]{"A_accepted", "A_finished", "A_received", "A_rejected", "A_return", "B_aborted", "B_finished", "C_deleted", "C_finished", "C_inwork", "C_new"};

    @BeforeMethod(alwaysRun = true)
    public void testC127321939UpdateFormRouteStatusNegativeScenarioAErrorPrecondition() throws Exception {
    ...
    public void testC127321939UpdateFormRouteStatusNegativeScenarioAError(){
