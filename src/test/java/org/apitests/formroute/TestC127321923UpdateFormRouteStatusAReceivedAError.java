...
public class TestC127321923UpdateFormRouteStatusAReceivedAError {

    private String statusBefore = "A_received";
    private String statusAfter = "A_error";

    @BeforeMethod
    public void testUpdateFormRouteStatusAReceivedAErrorPrecondition() throws Exception {
    ...
    @Test
    public void testUpdateFormRouteStatusAReceivedAError(){
