...
public class TestC136343852UpdateDocumentPrivileges {
    ...
    public void testC136343852UpdateDocumentPrivileges() throws IOException {
        ...
        Assert.assertEquals(response.jsonPath().getString("_messages.text[0]"), "Privileges set for document with path "+Globals.DOWNLOAD_DOCUMENT, "Response message text is not correct");
