...
public class TestC136343868CreateFolder404 {
    ...
    public void testC136343868CreateFolder404() throws IOException {
        ...
        Assert.assertTrue(response.jsonPath().getString("_messages.text").contains("Folder on path /aaa does not exist or is not accessible."), "Message text in the response is not correct");
