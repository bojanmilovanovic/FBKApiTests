...
public class TestC136343850GetDocumentVersion404 {

    @Test(groups = {"docshare", "tp1"})
    public void testC136343850GetDocumentVersion404() {
        ...
        Response response = request.get("/documents/version?path=aaa");
        ...
        Assert.assertFalse(response.jsonPath().getString("_messages.text").isEmpty(), "Document on path /aaa does not exist or is not accessible.");
