...
public class TestC136343854LockFolder {
    ...
    public void testC136343854LockFolder() {
        ...
        Assert.assertTrue(response.jsonPath().getString("_messages.text").contains("Folder /"+Globals.FUNDING_ID+"/"+Globals.FOLDER_NAME+" is successfully locked"), "Message text in the response is not correct");
