...
public class TestC136343855LockFolder409 {
    ...
    public void testC136343855LockFolder409() {
        ...
        Assert.assertTrue(response.jsonPath().getString("_messages.text").contains("Folder with path /"+Globals.FUNDING_ID+"/"+Globals.FOLDER_NAME+" already locked by tu_sap2portal"), "Message text in the response is not correct");
