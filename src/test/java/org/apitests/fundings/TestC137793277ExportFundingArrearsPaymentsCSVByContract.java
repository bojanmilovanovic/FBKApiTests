...
public class TestC137793277ExportFundingArrearsPaymentsCSVByContract {

    @Test(groups = {"fundings", "tp1"})
    public void testC137793277ExportFundingArrearsPaymentsCSVByContract() throws IOException {
        ...
        Response response = request.post("/fundings/arrearspayments/"+Globals.FUNDING_ADDITIONAL_TABS_ID+"/export?fileType=csv");
