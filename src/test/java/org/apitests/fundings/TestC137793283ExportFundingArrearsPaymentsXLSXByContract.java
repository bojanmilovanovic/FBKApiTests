...
public class TestC137793283ExportFundingArrearsPaymentsXLSXByContract {

    @Test(groups = {"fundings", "tp1"})
    public void testC137793283ExportFundingArrearsPaymentsXLSXByContract() throws IOException {
        ...
        Response response = request.post("/fundings/arrearspayments/"+Globals.FUNDING_ADDITIONAL_TABS_ID+"/export?fileType=xlsx");
