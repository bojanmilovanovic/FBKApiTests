...
public class TestC137032759SearchFundingPaymentsByContract {

    @Test(groups = {"fundings", "tp1"})
    public void testC137032759SearchFundingPaymentsByContract() throws IOException {
        ...
        Response response = request.post("/fundings/payments/"+Globals.FUNDING_ADDITIONAL_TABS_ID+"/search");
