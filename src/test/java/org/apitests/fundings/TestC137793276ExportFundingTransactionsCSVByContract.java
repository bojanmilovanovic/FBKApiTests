...
public class TestC137793276ExportFundingTransactionsCSVByContract {

    @Test(groups = {"fundings", "tp1"})
    public void testC137793276ExportFundingTransactionsCSVByContract() throws IOException {
        ...
        Response response = request.post("/fundings/transactions/"+Globals.FUNDING_ADDITIONAL_TABS_ID+"/export?fileType=csv");
