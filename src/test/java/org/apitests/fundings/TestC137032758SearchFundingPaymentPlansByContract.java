...
public class TestC137032758SearchFundingPaymentPlansByContract {

    @Test(groups = {"fundings", "tp1"})
    public void testC137032758SearchFundingPaymentPlansByContract() throws IOException {
        ...
        Response response = request.post("/fundings/paymentplans/"+Globals.FUNDING_ADDITIONAL_TABS_ID+"/search");
