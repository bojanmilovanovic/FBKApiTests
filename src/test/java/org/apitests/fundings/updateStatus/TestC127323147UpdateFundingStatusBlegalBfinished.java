...
public class TestC127323147UpdateFundingStatusBlegalBfinished {
    ...
    @BeforeMethod
    public void testC127323147UpdateFundingStatusBlegalBfinishedPrecondition() throws Exception {
    ...
    public void testC127323147UpdateFundingStatusBlegalBfinished(){
    ...
    @AfterMethod
    public void testC127323147UpdateFundingStatusBlegalBfinishedPostcondition() throws Exception {
        dbHelper.openDBConnectionFundings();
