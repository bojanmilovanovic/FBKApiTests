...
public class TestC127323147UpdateFundingStatusBlegalBfinished {
    ...
    @BeforeMethod
    public void testUpdateFundingStatusBlegalBfinishedPrecondition() throws Exception {
    ...
    public void testUpdateFundingStatusBlegalBfinished(){
    ...
    @AfterMethod
    public void testUpdateFundingStatusBlegalBfinishedPostcondition() throws Exception {
        dbHelper.openDBConnectionFundings();
