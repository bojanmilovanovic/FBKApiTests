...
public class TestC127323791UpdateFundingStatusNegativeScenariosBChanged {
    ...
    @BeforeMethod
    public void testUpdateFundingStatusNegativeScenariosBChangedPrecondition() throws Exception {
    ...
    public void testUpdateFundingStatusNegativeScenariosBChanged(){
    ...
    @AfterMethod
    public void testUpdateFundingStatusNegativeScenariosBChangedPostcondition() throws Exception {
        dbHelper.openDBConnectionFundings();
