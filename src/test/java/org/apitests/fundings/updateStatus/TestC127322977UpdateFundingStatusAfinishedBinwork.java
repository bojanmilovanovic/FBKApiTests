...
public class TestC127322977UpdateFundingStatusAfinishedBinwork {
    ...
    @BeforeMethod
    public void testUpdateFundingStatusAfinishedBinworkPrecondition() throws Exception {
    ...
    public void testUpdateFundingStatusAfinishedBinwork(){
    ...
    @AfterMethod
    public void testUpdateFundingStatusAfinishedBinworkPostcondition() throws Exception {
        dbHelper.openDBConnectionFundings();
