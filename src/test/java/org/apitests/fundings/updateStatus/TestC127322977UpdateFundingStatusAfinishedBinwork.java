...
public class TestC127322977UpdateFundingStatusAfinishedBinwork {

    private String statusBefore = "A_finished";
    private String statusAfter = "B_inwork";
    DBHelper dbHelper = new DBHelper();

    @BeforeMethod(alwaysRun = true)
    public void testC127322977UpdateFundingStatusAfinishedBinworkPrecondition() throws Exception {
    ...
    public void testC127322977UpdateFundingStatusAfinishedBinwork(){
    ...
    public void testC127322977UpdateFundingStatusAfinishedBinworkPostcondition() throws Exception {
        dbHelper.openDBConnectionFundings();
