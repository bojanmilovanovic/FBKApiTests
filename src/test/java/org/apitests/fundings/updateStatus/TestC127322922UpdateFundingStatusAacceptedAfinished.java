...
public class TestC127322922UpdateFundingStatusAacceptedAfinished {
    ...
    @BeforeMethod
    public void testUpdateFundingStatusAacceptedAfinishedPrecondition() throws Exception {
    ...
    @Test
    public void testUpdateFundingStatusAacceptedAfinished(){
    ...
    @AfterMethod
    public void testUpdateFundingStatusAacceptedAfinishedPostcondition() throws Exception {
        dbHelper.openDBConnectionFundings();
