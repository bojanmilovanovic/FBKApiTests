...
public class TestC137793278ExportFundingPaymentPlansCSVByContract {

    @Test(groups = {"fundings", "tp1"})
    public void testC137793278ExportFundingPaymentPlansCSVByContract() throws IOException {
        ...
        Response response = request.post("/fundings/paymentplans/"+Globals.FUNDING_ADDITIONAL_TABS_ID+"/export?fileType=csv");
