...
public class TestC137793284ExportFundingPaymentPlansXLSXByContract {

    @Test(groups = {"fundings", "tp1"})
    public void testC137793284ExportFundingPaymentPlansXLSXByContract() throws IOException {
        ...
        Response response = request.post("/fundings/paymentplans/"+Globals.FUNDING_ADDITIONAL_TABS_ID+"/export?fileType=xlsx");
