...
public class TestC146969354RetrieveTasksForFunding404 {

    @Test(groups = {"fundings", "tp1"})
    public void testC146969354RetrieveTasksForFunding404() throws IOException {
        ...
        Response response = request.post("/fundings/aaa/tasks");
        Assert.assertEquals(response.getStatusCode(), 404, "Status code is not 200");
