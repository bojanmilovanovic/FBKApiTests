...
public class TestC127324228GetDynamicFormFormatted {

    @BeforeMethod
    public void testGetDynamicFormFormattedPrecondition() throws IOException {
    ...
    @Test
    public void testGetDynamicFormFormatted() throws IOException {
        ...
        Response response = request.get("/dynamicform/"+dynamicFormId+"/formatted");
    ...
    @AfterMethod
    public void testGetDynamicFormFormattedPostcondition() throws IOException {
